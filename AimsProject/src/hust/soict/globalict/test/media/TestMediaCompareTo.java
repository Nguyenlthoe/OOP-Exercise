...
public class TestMediaCompareTo {
	...
	public static void main(String args[]) {
		...
		Media aMedia = dvd1;
		DigitalVideoDisc dvd2 = (DigitalVideoDisc) aMedia;
		System.out.println(dvd2.getLength());
...
//		DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladdin","Animation",null,90,39.7f);
//		collection.add(dvd2);
//		collection.add(dvd1);
//		collection.add(dvd3);
//		
